...
public class JdbcSpittleRepository implements SpittleRepository {
	...
	public long count() {
		return jdbcTemplate.queryForObject("select count(id) from Spittle",Integer.class);
	}
